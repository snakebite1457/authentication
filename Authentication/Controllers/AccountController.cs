...
namespace Authentication.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> ForgotPassword(ForgotPasswordModel model)
        {
            ...
            return Ok(await _repo.ForgotPassword(model));
        ...
        public async Task<IHttpActionResult> ResetPassword(ResetPasswordModel model)
        {
            ...
            IdentityResult result = await _repo.ResetPassword(model);

            // Make no difference between success and failure, bacause this gives potential attackers an opportunity
        ...
        public async Task<IHttpActionResult> RegisterExternal(RegisterExternalBindingModel model)
        {
            ...
            IdentityUser user = await _repo.FindAsync(new UserLoginInfo(model.Provider, verifiedAccessToken.UserId));
        ...
        public async Task<IHttpActionResult> ObtainLocalAccessToken(string provider, string externalAccessToken)
        {
            ...
            IdentityUser user = await _repo.FindAsync(new UserLoginInfo(provider, verifiedAccessToken.UserId));
